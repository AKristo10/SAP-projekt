...
#ANOVA test
  ...
  U ovom odjeljku ćemo provesti ANOVA test varijanci na temelju sljedećih hipoteza.
$$ \begin{aligned}
  H_0 & : \mu_A = \mu_E = \mu_N \\
  H_1 & : \neg H_0.
\end{aligned} $$
...
istočne Azije svjesnija od ostatka populacije. 
...
Iz testa homogenosti koji je nužan za Anovu možemo zaključiti da varijance nisu homogene, no opet uzevši u obzir 
